...
<style id="applicationStylesheet" type="text/css">
	...
	#Silahkan_login_dengan_akun_yan {
		opacity: 0.5;
		position: absolute;
		left: 169px;
		top: 310.396px;
	...
	#Logo_Polban {
		opacity: 1;
		fill: url(#Logo_Polban_A8_Rectangle_150_pattern);
	}
	.Logo_Polban {
		position: absolute;
		overflow: visible;
...
<div id="Web___1">
	<div id="text">
		<svg class="Rectangle_163">
			<rect id="Rectangle_163" rx="0" ry="0" x="0" y="0" width="800" height="1080">
			</rect>
		</svg>
		<div id="KoTA_106___2019">
			<span>KoTA 106 - 2019</span>
		</div>
		<div id="RememberMe">
			<svg class="Rectangle_165">
				<rect id="Rectangle_165" rx="4" ry="4" x="0" y="0" width="18" height="18">
				</rect>
			</svg>
			<div id="Remember_me">
		...
		<div id="btn_login">
			<svg class="Rectangle_166">
				<rect id="Rectangle_166" rx="4" ry="4" x="0" y="0" width="185" height="50">
				</rect>
			</svg>
			<div id="Login">
				<span>Login</span>
		...
		<div id="label">
			<div id="label_A8_Group_234">
				<div id="E_mail">
					<span>E-mail</span>
				</div>
				<svg class="Path_297" viewBox="-835.08 2509.809 400 2">
					<path id="Path_297" d="M -835.0799560546875 2509.80859375 C -835.0799560546875 2509.80859375 -435.0799560546875 2509.80859375 -435.0799560546875 2509.80859375">
					</path>
				</svg>
			</div>
			<div id="label_A8_Group_235">
				<div id="Password">
					<span>Password</span>
				</div>
				<svg class="Path_297_A8_Path_150" viewBox="-835.08 2509.809 400 2">
					<path id="Path_297_A8_Path_150" d="M -835.0799560546875 2509.80859375 C -835.0799560546875 2509.80859375 -435.0799560546875 2509.80859375 -435.0799560546875 2509.80859375">
					</path>
				</svg>
			</div>
		</div>
		<div id="Silahkan_login_dengan_akun_yan">
			<span>Silahkan login dengan akun yang sudah terdaftar sebelumnya<br/></span>
		</div>
		<div id="Logo">
			<span>Chatbot Informasi Kampus Polban</span>
		</div>
	</div>
	<div id="Group_244">
		<svg class="Rectangle_176">
			<linearGradient spreadMethod="pad" id="LinearGradientFill1" x1="0.8971014618873596" x2="0.2061193883419037" y1="0.14020411670207977" y2="0.8766311407089233">
				<stop offset="0" stop-color="#242348" stop-opacity="1"></stop>
				<stop offset="1" stop-color="#5a55aa" stop-opacity="1"></stop>
			</linearGradient>
			<rect id="Rectangle_176" rx="0" ry="0" x="0" y="0" width="800" height="1080">
			</rect>
		</svg>
		<svg class="Logo_Polban">
			<pattern elementId="Logo_Polban_A8_Rectangle_150" id="Logo_Polban_A8_Rectangle_150_pattern" x="0" y="0" width="100%" height="100%">
				<image x="0" y="0" width="100%" height="100%" href="Logo_Polban_A8_Rectangle_150_pattern.png" xlink:href="Logo_Polban_A8_Rectangle_150_pattern.png"></image>
			</pattern>
			<rect id="Logo_Polban" rx="0" ry="0" x="0" y="0" width="215" height="305">
			</rect>
		</svg>
	</div>
	<div id="SIgn_Up">
